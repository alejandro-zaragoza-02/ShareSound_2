...
static void Main (string[] args)
{
        ...
        System.Console.WriteLine ("A new database called: ShareSound_2GenNHibernate will be created (the previous information will be deleted).");
        System.Console.WriteLine ("-----------------------------------------------------------------------------");
        ...
        {
                if (ans.ToLower () == "y") {
                        CreateDB.Create ("ShareSound_2GenNHibernate", "nhibernateUser", "nhibernatePass");
